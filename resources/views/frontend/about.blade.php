    ...
    <section class="relative bg-gradient-to-b from-blue-50 to-white py-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-xl text-gray-600 mb-8">Skoolbridge is on a mission to revolutionize how educational
                    institutions manage their operations and engage with their communities.</p>
                <div class="flex justify-center gap-4">
                    <button
                        class="px-8 py-3 bg-[#276F98] text-white rounded-lg hover:bg-blue-700 transition-colors font-semibold">
                        Get Started
                    </button>
                    <button
                        class="px-8 py-3 border-2 border-[#276F98] text-[#276F98] rounded-lg hover:bg-blue-50 transition-colors font-semibold">
                        Learn More
                    </button>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <img src="{{ asset('asset/images/about.jpg') }}" alt="Our Journey"
                ...
                <div class="order-1 md:order-2">
                    ...
                    <p class="text-xl text-gray-600 mb-8">Founded in 2025, Skoolbridge has been dedicated to creating
                        innovative solutions that empower educational institutions worldwide.</p>
    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-xl text-gray-600">Our core values shape everything we do and guide us in creating meaningful
                    impact in education.</p>
            </div>
